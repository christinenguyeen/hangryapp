...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `preferences` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '723f5a693f40aac54a4fdddc66170a66')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsPreferences = new HashMap<String, TableInfo.Column>(2);
        _columnsPreferences.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPreferences.put("name", new TableInfo.Column("name", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final TableInfo _existingPreferences = TableInfo.read(_db, "preferences");
        if (! _infoPreferences.equals(_existingPreferences)) {
          return new RoomOpenHelper.ValidationResult(false, "preferences(com.example.hangryapp.data.PreferenceData).\n"
                  + " Expected:\n" + _infoPreferences + "\n"
                  + " Found:\n" + _existingPreferences);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "723f5a693f40aac54a4fdddc66170a66", "4345f9e2076972340061047aef87173b");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "preferences");
  }
